...
Dit script bouwt de database structuur voor de Tennis database gebruikt in verschillende oefeningen
...
*/
DROP DATABASE IF EXISTS TENNIS3; #Regel die database verwijderd moest deze al bestaan
CREATE DATABASE TENNIS3; #Regel die een lege database TENNIS aanmaakt
USE TENNIS3; #Vanaf nu wordt alles in database TENNIS uitgevoerd, dus hoeft de prefix "`TENNIS`." niet gebruikt te worden
...
;
CREATE TABLE TEAMS
      (TEAMNR       TINYINT NOT NULL PRIMARY KEY,
...
;
INSERT INTO SPELERS VALUES (
112, 'Baalen, van', 'IP', '1963-10-11', 'V', 1984, 'Vosseweg', 
